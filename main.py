...
# make list of possible fortunes
	...
	"Consider eating more fortune coookies",
	"You have tamed the might python, now you mucst free it onto the Great Spider's Web!"]
...
class MainHandler(webapp2.RequestHandler):
    def get(self):
    	...
    	content = header + fortune_paragraph + number_paragrah
